...
REM
REM Generated by Vivado on Fri Jan 26 10:59:47 +0100 2024
...
call xsim  test_pulse_gen_time_impl -key {Post-Implementation:sim_1:Timing:test_pulse_gen} -tclbatch test_pulse_gen.tcl -log simulate.log
