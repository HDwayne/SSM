...
REM
REM Generated by Vivado on Thu Feb 15 17:48:03 +0100 2024
...
call xsim  test_fifo_behav -key {Behavioral:sim_1:Functional:test_fifo} -tclbatch test_fifo.tcl -log simulate.log
