...
REM
REM Generated by Vivado on Thu Feb 08 17:00:00 +0100 2024
...
call xsim  test_memory_behav -key {Behavioral:sim_1:Functional:test_memory} -tclbatch test_memory.tcl -log simulate.log
