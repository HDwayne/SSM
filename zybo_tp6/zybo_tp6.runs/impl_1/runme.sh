...
HD_PWD='C:/Users/hdway/Documents/vivado/SSM/zybo_tp6/zybo_tp6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memory.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source memory.tcl -notrace
